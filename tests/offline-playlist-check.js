...
assert.match(sw, /const CACHE_STATIC_NAME = 'malamusic-static-v154'/);
...
for (const required of ['/app.js?v=154', '/player.js?v=154', '/library.js?v=154', '/album.js?v=154']) {
  assert.ok(scriptUrls.includes(required), `asset marker missing: ${required}`);
}
assert.match(index, /sw\.js\?v=154/);
