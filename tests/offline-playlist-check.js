...
assert.match(sw, /const CACHE_STATIC_NAME = 'malamusic-static-v155'/);
...
for (const required of ['/app.js?v=155', '/player.js?v=155', '/library.js?v=155', '/album.js?v=155']) {
  assert.ok(scriptUrls.includes(required), `asset marker missing: ${required}`);
}
assert.match(index, /sw\.js\?v=155/);
