...
assert.match(api, /function userKey\(currentUser\)/);
assert.match(api, /currentUser\.email \|\| currentUser\.uid/);
assert.match(api, /function legacyUserKey\(currentUser\)/);
...
assert.match(index, /MALA_SW_VERSION = 'v156'/);
assert.match(index, /stats\.js\?v=156/);
...
assert.match(sw, /stats\.js\?v=156/);
