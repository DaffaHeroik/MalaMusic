...
assert.match(source, /var source = isOfflineAudioUrl\(rawUrl\) \? rawUrl : \('\/api\/proxy-audio\?url=' \+ encodeURIComponent\(rawUrl\)\)/);
assert.match(source, /isOfflineAudioUrl\(rawUrl\)/);
